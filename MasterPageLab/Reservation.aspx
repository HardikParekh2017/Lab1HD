...
<asp:Content ID="aaa" runat="server" ContentPlaceHolderID="mainContentPlaceHolder">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 bedtype">
                        <asp:RadioButtonList ID="RadioButton" runat="server" RepeatDirection="Vertical"  >
                            <asp:ListItem>King</asp:ListItem>
                            <asp:ListItem>Two Queens</asp:ListItem>
                            <asp:ListItem>Single Queen</asp:ListItem>
                        </asp:RadioButtonList>
                        <!-- radio buttons -->
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-7">
                        <asp:TextBox ID="txtSpecialRequest" TextMode="MultiLine" runat="server" CssClass="form-control" Height="100" Width="450"></asp:TextBox>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                         <asp:TextBox ID="txtPhnNumber" runat="server"
                            CssClass="form-control"></asp:TextBox>
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtPhnNumber" 
